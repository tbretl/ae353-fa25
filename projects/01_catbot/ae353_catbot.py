...
class Simulator:
    def __init__(
        ...
        self.number_of_cats = 1 if launch_cat else 0
        ...
        self.launch_pause = self.rng.uniform(low=1., high=2.)
        self.wheel_radius = 0.5
        self.wheel_to_body = 0.15 # FIXME: same as chassis_to_axle?
        self.body_height = 1.0
        self.wheel_base = 0.8
        self.chassis_to_axle = 0.15
    ...
    def reset(
        ...
        if initial_conditions is None:
            initial_wheel_position=self.rng.uniform(-1.0, 1.0)
            initial_wheel_velocity=self.rng.uniform(-0.1, 0.1)
            initial_pitch_angle=self.rng.uniform(-0.1, 0.1)
            initial_pitch_rate=self.rng.uniform(-0.1, 0.1)
        else:
            initial_wheel_position=initial_conditions['wheel_position']
            initial_wheel_velocity=initial_conditions['wheel_velocity']
            initial_pitch_angle=initial_conditions['pitch_angle']
            initial_pitch_rate=initial_conditions['pitch_rate']
    ...
    def did_save_cat(self):
        return (self.get_number_of_cats_saved() > 0)
